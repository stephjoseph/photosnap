<script>
  ...
  const handleMouseOver = (icon) => {
    ...
    switch (icon) {
      case 'facebook':
        ...
        break;
      case 'youtube':
        isYoutubeHovered = true;
        break;
      case 'twitter':
        isTwitterHovered = true;
        break;
      case 'pinterest':
        isPinterestHovered = true;
        break;
      case 'instagram':
        isInstagramHovered = true;
        break;
      default:
        break;
    }
  ...
  const handleMouseOut = (icon) => {
    // Reset the hovered state for the corresponding icon
    switch (icon) {
      case 'facebook':
...
<footer
  class="flex w-full flex-col items-center gap-[7.5rem] bg-pure-black px-8 py-14 md:hidden"
>
  <div class="flex w-full flex-col items-center gap-8">
      ...
      <li>
        <a href="/">
          <svg
            ...
            width="20"
            height="20"
            fill={isFacebookHovered
              ? 'url(#facebook-hover-mobile)'
              : 'url(#facebook-normal-mobile)'}
            on:mouseover={() => handleMouseOver('facebook')}
            on:mouseout={() => handleMouseOut('facebook')}
            on:focus={() => handleMouseOver('facebook')}
            on:blur={() => handleMouseOut('facebook')}
            role="button"
            tabindex="0"
          >
            <!-- Define gradients for Facebook -->
            <defs>
              <linearGradient
                id="facebook-hover-mobile"
                x1="100%"
                x2="0%"
                y1="0%"
                y2="100%"
      ...
      <li>
        <a href="/">
          <svg
            ...
            width="20"
            height="20"
            fill={isYoutubeHovered
              ? 'url(#youtube-hover-mobile)'
              : 'url(#youtube-normal-mobile)'}
            on:mouseover={() => handleMouseOver('youtube')}
            on:mouseout={() => handleMouseOut('youtube')}
            on:focus={() => handleMouseOver('youtube')}
            on:blur={() => handleMouseOut('youtube')}
            role="button"
            tabindex="0"
          >
            <!-- Define gradients for youtube -->
      ...
      <li>
        <a href="/">
          <svg
            ...
            width="20"
            height="20"
            fill={isTwitterHovered
              ? 'url(#twitter-hover-mobile)'
              : 'url(#twitter-normal-mobile)'}
            on:mouseover={() => handleMouseOver('twitter')}
            on:mouseout={() => handleMouseOut('twitter')}
            on:focus={() => handleMouseOver('twitter')}
            on:blur={() => handleMouseOut('twitter')}
            role="button"
            tabindex="0"
          >
            <!-- Define gradients for twitter -->
            <linearGradient id="a" x1="0%" x2="100%" y1="100%" y2="0%"
              ><stop offset="0%" stop-color="#D3205A" /><stop
                offset="100%"
                stop-color="#FF5A5A"
      ...
      <li>
        <a href="/">
          <svg
            ...
            width="20"
            height="20"
            fill={isPinterestHovered
              ? 'url(#pinterest-hover-mobile)'
              : 'url(#pinterest-normal-mobile)'}
            on:mouseover={() => handleMouseOver('pinterest')}
            on:mouseout={() => handleMouseOut('pinterest')}
            on:focus={() => handleMouseOver('pinterest')}
            on:blur={() => handleMouseOut('pinterest')}
            role="button"
            tabindex="0"
          >
            <!-- Define gradients for pinterest -->
            <linearGradient id="a" x1="0%" x2="100%" y1="100%" y2="0%"
              ><stop offset="0%" stop-color="#D3205A" /><stop
                offset="100%"
                stop-color="#FF5A5A"
      ...
      <li>
        <a href="/">
          <svg
            ...
            width="20"
            height="20"
            fill={isInstagramHovered
              ? 'url(#instagram-hover-mobile)'
              : 'url(#instagram-normal-mobile)'}
            on:mouseover={() => handleMouseOver('instagram')}
            on:mouseout={() => handleMouseOut('instagram')}
            on:focus={() => handleMouseOver('instagram')}
            on:blur={() => handleMouseOut('instagram')}
            role="button"
            tabindex="0"
          >
            <!-- Define gradients for instagram -->
            <linearGradient id="a" x1="0%" x2="100%" y1="100%" y2="0%"
              ><stop offset="0%" stop-color="#D3205A" /><stop
                offset="100%"
                stop-color="#FF5A5A"
            ...
            <defs>
              <linearGradient
                ...
                ><stop offset="0%" stop-color="#FFC593" /><stop
                  offset="51.945%"
                  stop-color="#BC7198"
                /><stop offset="100%" stop-color="#5A77FF" /></linearGradient
              >
              <linearGradient
                id="instagram-normal-mobile"
                x1="0%"
                x2="50%"
                y1="100%"
                y2="0%"
    ...
    <nav class="w-full">
      <ul class="flex w-full flex-col gap-5">
        <li class="w-full">
          <a
            class="block w-full text-center text-[0.75rem] font-bold uppercase leading-4 tracking-[2px] text-pure-white transition-colors hover:text-pure-white/30 active:text-pure-white/30"
            href="/">Home</a
          >
        </li>
        <li class="w-full">
...
<style>
  ...
  svg.facebook:hover {
    fill: url(#facebook-hover-mobile); /* Change this to the id of your new gradient for Facebook */
  }

  svg.youtube:hover {
    fill: url(#youtube-hover-mobile); /* Change this to the id of your new gradient for YouTube */
  }

  svg.twitter:hover {
    fill: url(#twitter-hover-mobile); /* Change this to the id of your new gradient for Twitter */
  }

  svg.pinterest:hover {
    fill: url(#pinterest-hover-mobile); /* Change this to the id of your new gradient for Pinterest */
  }

  svg.instagram:hover {
    fill: url(#instagram-hover-mobile); /* Change this to the id of your new gradient for Instagram */
  }
</style>
