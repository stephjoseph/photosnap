...
<section class="w-full">
  ...
  <div class="grid w-full grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
    {#each featured as item}
      <div
        class="group relative h-[100vw] w-full bg-cover bg-center bg-no-repeat transition-transform hover:-translate-y-6 active:-translate-y-6 md:h-[65.10vw] xl:h-[34.65vw]"
